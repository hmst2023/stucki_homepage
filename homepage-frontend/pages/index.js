...
const index = ({entries}) => {
  return (
    <div className="bg-cover bg-center p-5" style={{backgroundImage: `url(https://res.cloudinary.com/du2jqqdk2/image/upload/v1708462222/b4yhuszmwjw6h041i5q0.jpg)`, height: '100vh'}}>
